  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Discover competitive and sideline cheerleading programs for youth athletes in Carbon County, PA. Olympian Booster Club offers comprehensive cheer training and team opportunities."
        />
        <meta
          name="keywords"
